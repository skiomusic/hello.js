/*! hellojs v1.14.2 | (c) 2012-2017 Andrew Dodson | MIT https://adodson.com/hello.js/LICENSE */
// ES5 Object.create
if (!Object.create) {
...
hello.utils.extend(hello, {
	...
	login: function() {
		...
		p.qs.state = Base64.encode(JSON.stringify(p.qs.state));
...
hello.utils.extend(hello.utils, {
	...
	responseHandler: function(window, parent) {
		...
		if (p && p.state && (p.code || p.oauth_token)) {
			...
			var state = JSON.parse(Base64.decode(p.state));
		...
		if (p && 'state' in p) {
			...
			try {
				...
				var a = JSON.parse(Base64.decode(p.state));
